...
class App {
  ...
  createMedias(items?: GalleryItem[], bend = 1, textColor?: string, borderRadius?: number, font?: string) {
    const defaultItems: GalleryItem[] = [
      { image: `https://picsum.photos/seed/1/800/600?grayscale`, text: 'AI Portrait' },
      { image: `https://picsum.photos/seed/2/800/600?grayscale`, text: '3D Model' },
      { image: `https://picsum.photos/seed/3/800/600?grayscale`, text: 'Artistic Style' },
      { image: `https://picsum.photos/seed/4/800/600?grayscale`, text: 'Professional' },
      { image: `https://picsum.photos/seed/5/800/600?grayscale`, text: 'Fantasy' },
      { image: `https://picsum.photos/seed/6/800/600?grayscale`, text: 'Cyberpunk' },
      { image: `https://picsum.photos/seed/7/800/600?grayscale`, text: 'Vintage' },
      { image: `https://picsum.photos/seed/8/800/600?grayscale`, text: 'Anime' },
      { image: `https://picsum.photos/seed/9/800/600?grayscale`, text: 'Realistic' },
      { image: `https://picsum.photos/seed/10/800/600?grayscale`, text: 'Abstract' },
      { image: `https://picsum.photos/seed/11/800/600?grayscale`, text: 'Minimalist' },
      { image: `https://picsum.photos/seed/12/800/600?grayscale`, text: 'Creative' }
    ];
